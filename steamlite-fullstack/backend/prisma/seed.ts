...
const gameSeeds: GameSeed[] = [
  ...
  },
  {
    ...
    description: "You've inherited your grandfather's old farm plot in Sunmoist Canyon. Armed with hand-me-down tools and a few coins, you set out to begin your new life. Can you learn to live off the land and turn these overgrown fields into a thriving home?",
    price: 5.99,
    discountPercent: 0,
    genre: "Farming Sims, Pixel Graphics, Multiplayer, RPG",
