...
const developerSeeds: DeveloperSeed[] = [
  ...
  {
    username: "activision",
    email: "contact@activision.local",
    password: "Dev123!",
    company: "Activision",
    profile: "Leading game developer and publisher.",
  },
  {
...
const gameSeeds: GameSeed[] = [
  ...
  },
  {
    ...
    price: 39.99,
    discountPercent: 0,
    genre: "Multiplayer, Shooter, Zombie",
    coverImageUrl: "/assets/call-of-duty-black-ops.jpg",
    releaseDate: "2010-11-09",
    developerCompany: "Activision",
  },
  {
    ...
    coverImageUrl: "/assets/call-of-duty-modern-warfare.jpg",
